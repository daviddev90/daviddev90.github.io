---layout: singletitle: "[C03 분류]02 이진분류기 성능측정 방법"categories: mathtag: [python, ml, math]toc: trueauthor_profile: falsetypora-root-url: ../sidebar:  nav: "docs"---
### train test set 준비
``` python
import numpy as np
...
```
![](/images/2023-07-09-124452/22_0.png)
...
```
![](/images/2023-07-09-124452/24_0.png)
...
![](/images/2023-07-09-124452/35_1.png)
### 결과
