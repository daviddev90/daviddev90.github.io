...
<div><op>GridSearchCV(cv=5, estimator=RandomForestRegressor(),
...
<div><op>{'max_features': 6, 'n_estimators': 30}</op></div>
...
<div><op>RandomForestRegressor(max_features=6, n_estimators=30)</op></div>
...
<div><op>array([8.64292565e-02, 8.50441983e-02, 4.05437328e-02, 2.52969951e-02,
...
<div><op>[(0.40842507569601877, 'median_income'),
...
<div><op>  warnings.warn(
</op><br></div>

<div><op>62756.60972413835</op></div>
