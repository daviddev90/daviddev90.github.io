...
<nav class="cods"><h2>C03 분류 posts</h2><ol><li><p>(current) 01 MNIST 이진분류</p></li><li><a href="/ml/C03_분류~02_이진분류기_성능측정_방법">02 이진분류기 성능측정 방법</a></li><li><a href="/ml/C03_분류~03_다항분류-작성중">03 다항분류-작성중</a></li></ol></nav>
...
![](/images/2023-07-09-C03_분류~01_MNIST_이진분류.ipynb/7_1.png)
### 레이블 확인
