...
<div class="cods"><h2>C03 분류 시리즈 목차</h2><a href="/ml/C03_분류~01_MNIST_이진분류/">01 MNIST 이진분류</a><p><b>(현재 글) 02_이진분류기_성능측정_방법</b></p><a href="/ml/C03_분류~03_다항분류-작성중/">03 다항분류-작성중</a></div>
...
```
![](/images/C03_분류~02_이진분류기_성능측정_방법/22_0.png)
...
```
![](/images/C03_분류~02_이진분류기_성능측정_방법/24_0.png)
...
```
![](/images/C03_분류~02_이진분류기_성능측정_방법/29_0.png)
#### 대략적인 해석
...
![](/images/C03_분류~02_이진분류기_성능측정_방법/35_1.png)
### 결과
